...
def test_create_summary(test_app, monkeypatch):
    test_request_payload = {"url": "https://danijel.co"}
    test_response_payload = {"id": 1, "url": "https://danijel.co"}
...
def test_remove_summary(test_app, monkeypatch):
    ...
    assert response.status_code == 200
    assert response.json() == {"id": 1, "url": "https://danijel.co"}
...
def test_update_summary(test_app, monkeypatch):
    test_request_payload = {"url": "https://danijel.co", "summary": "updated"}
...
@pytest.mark.parametrize(
    ...
    [
        [
            999,
            {"url": "https://danijel.co", "summary": "updated!"},
            404,
            "Summary not found",
        ],
        [
